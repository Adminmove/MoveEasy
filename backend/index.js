...
const easyfuelRoutes = require('./src/routes/easyfuel');
const easytransectRoutes = require('./src/routes/easytransect');
const safebetRoutes = require('./src/routes/safebet');
const greenwalletRoutes = require('./src/routes/greenwallet');
const mmpaiRoutes = require('./src/routes/mmpai');
...
// ================================================================
app.use(express.static(path.join(__dirname, '../frontend/moveeasy-core'), {
  index: false,
...
app.get('/', (req, res) => {
  res.sendFile(path.join(__dirname, '../frontend/moveeasy-core/index.html'));
});
